...
import css from 'styles/betCenter/Base/GameBoard1.less';
import {type as TYPE, codeResult, rounding} from 'utils';
import GAME_RESULT from 'utils/codeResult';
...
class Gameboard extends Component {
  ...
  constructor(props, context) {
    ...
    this.getLabelPrizeAmount = this.getLabelPrizeAmount.bind(this);
  }
  ...
  render() {
    const {thisMethodSetting, thisMethodPrizeSetting, thisGameId} = this.props;
