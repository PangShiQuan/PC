...
import agentSVG from '../../assets/image/floatWindow/ic-agent.svg';
import testlineSVG from '../../assets/image/floatWindow/ic-testline.svg';
    ...
    if (float === 'left') {
      const lineBtn = (
        <a
          ...
          href="https://media.gaofushuai1945.com/redbag-1/index.html">
          <SVG
            src={testlineSVG}
            className={classnames(css.downScale, css.icon__svg)}
          />
          <SVG src={testlineSVG} className={css.allIcon} />
          <span className={css.desc}>现金红包</span>
        </a>
      );
      const agentBtn = (
        <a
          ...
          rel="noopener noreferrer"
          target="_blank"
          href="https://ttdl1.vip/998dl/">
          <SVG
            src={agentSVG}
            className={classnames(css.downScale, css.icon__svg)}
          />
          <SVG src={agentSVG} className={css.allIcon} />
    ...
    return (
      <div
        ...
        <div className={css.QRCode}>
          ...
          <div className={classnames(css.QRCode_desc, css.desc)}>
            {text.QR}
            {osName}APP
          </div>
          <div className={css.desc_quote}>赠送18元彩金</div>
        </div>
      </div>
    );
  }
