        ...
        <section
          ...
          <div className={css.container__decoration}>
            <div className={css.mobileSite_introFlex}>
              <img alt="手机购彩" src={image.screenIntro} role="presentation" />
        ...
        <section
          ...
          <figure className={css.container__flexVertical}>
            ...
            <div
              ...
              <img alt="产品服务" src={image.feature1} role="presentation" />
              <p>
                <span>产品服务</span>
                <span>投注简单 支付方便</span>
              </p>
            ...
            <div className={classnames(css.features__item, css.box__desc)}>
              <img alt="银行服务" src={image.feature2} role="presentation" />
              <p>
                <span>银行服务</span>
            ...
            <div className={classnames(css.features__item, css.box__desc)}>
              <img alt="值得信赖" src={image.feature3} role="presentation" />
              <p>
                <span>值得信赖</span>
                <span>政府颁发执照</span>
              </p>
