  ...
  renderQRItem(platform) {
    ...
    return (
      <div className={css.container__flexVertical}>
        ...
        <div className={css.QRBorder}>
          <div className={css.QRBoxBorder}>
            <QRCode text={appDownloadLink} size={150} />
          </div>
        </div>
      </div>
    );
  ...
  render() {
    return (
      <article className={css.article}>
        <section className={classnames(css.topBackground, css.background)}>
          <div className={classnames(css.container__flex, css.featured)}>
            <div className={css.topIntro}>
              ...
              <div className={classnames(css.container__flex, css.group)}>
        ...
        <section className={classnames(css.background, css.bottomFeatures)}>
          <div className={classnames(css.container__flex, css.features)}>
