...
const css = resolve.client('styles/homepage/FloatWindows.less');
  ...
  class FloatWindows extends Component {
    ...
    renderButtons() {
      const {accessToken, deviceToken, pcOtherInfo, otherSettings, float} = this.props;
      ...
      const {paySwitch = true} = otherSettings;
      const trial = paySwitch
        ? {
